...
insert into public.campaigns (id, slug, partner_name, title, description, type, fundraiser_id, limit_amount, rate, image, review, start_at, end_at, created_at) values
  ('33333333-0000-4000-8000-000000000001', 'double-heart', '초록내일 컴퍼니', '함께하면 두 배가 되는 마음', '여러분의 나눔에 초록내일 컴퍼니가 같은 마음을 보탭니다.', 'matching', '22222222-0000-4000-8000-000000000001', 1000000, 1, '/assets/images/community.jpg', 'draft', (now() + interval '-20 days'), (now() + interval '12 days'), (now() + interval '-20 days')),
  ('33333333-0000-4000-8000-000000000002', 'small-promise', '초록내일 컴퍼니', '지구를 위한 작은 약속', '오늘 한 번, 일회용품 줄이기를 함께 약속해요. 응원은 금전 기부로 환산되지 않습니다.', 'cheer', '22222222-0000-4000-8000-000000000004', 0, 1, '/assets/images/forest.jpg', 'draft', (now() + interval '-20 days'), (now() + interval '12 days'), (now() + interval '-20 days'))
