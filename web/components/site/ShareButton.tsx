...
export function ShareButton({ className = 'button secondary', label = '공유', title, text }: { className?: string; label?: string; title?: string; text?: string }) {
  ...
  return (
    ...
    }}><Share2 aria-hidden="true" /> {label}</button>
  );
}
